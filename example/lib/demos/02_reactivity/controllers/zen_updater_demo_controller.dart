...
/// Controller specifically for demonstrating ZenUpdater functionality
/// Uses plain values + update() instead of reactive observables
class ZenUpdaterDemoController extends ZenController {
  // Plain values (no .obs())
  int _counter = 0;
  String _message = 'Hello ZenUpdater!';
  ...
  void onInit() {
    ...
    ZenLogger.logDebug('ZenUpdaterDemoController initialized');
  }
  ...
  @override
  void onClose() {
    ZenLogger.logDebug('ZenUpdaterDemoController disposed');
    super.onClose();
  }
}
